...
<template>
    <AppLayout title="Dashboard">
        ...
        <div class="flex space-x-5 justify-between">
            <div>
                <div class="bg-sky-950 text-white mt-2 rounded-r-2xl divide-y divide-sky-800">
                    <div class="text-center p-7 rounded-tr-2xl hover:bg-sky-900 cursor-pointer">
                        <i class="material-icons text-3xl ">
                            payment
                        </i>
                        <div>
                    ...
                    <div class="text-center p-7  hover:bg-sky-900 cursor-pointer">
                        <i class="material-icons text-3xl ">
                            trending_up
                        </i>
                        <div>
                    ...
                    <div class="text-center p-7 rounded-br-2xl hover:bg-sky-900 cursor-pointer">
                        <i class="material-icons text-3xl ">
                            person
                        </i>
                        <div>
            ...
            <div class="py-4 max-sm:px-0">
                <div class="sm:px-6 lg:px-1">
                    <div class="flex items-center justify-center shadow-lg text-white bg-gradient-to-r from-sky-950 to-indigo-950 overflow-hidden sm:rounded-lg px-20  max-sm:px-0">
                        <div class="max-sm:w-full max-sm:pl-0 py-10">
            ...
            <div class="mt-10">
                <div class="bg-slate-900 text-white p-4 text-center rounded-l-2xl divide-y divide-slate-700">
