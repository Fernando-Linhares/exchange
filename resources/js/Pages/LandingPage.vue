        ...
        <footer class="bg-gray-800 text-gray-300 py-10">
            <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="mb-4">
                        Leading cryptocurrency exchange platform offering secure and reliable trading services.
                    </p>
                    <p>1234 Crypto Street, Block 567</p>
                    <p>Cryptoville, CR 10101</p>
                    <p>Email: support@gbyexchange.com</p>
                </div>

                <!-- Quick Links -->
                <div>
                    <h2 class="text-white font-bold text-xl mb-4 mt-20">Quick Links</h2>
                    <ul>
                ...
                <!-- Resources -->
                <div>
                    <h2 class="text-white font-bold text-xl mb-4 mt-20">Resources</h2>
                    <ul>
                        <li><a href="#" class="hover:text-white">Help Center</a></li>
                        <li><a href="#" class="hover:text-white">API Documentation</a></li>
                        <li><a href="#" class="hover:text-white">Blog</a></li>
                        <li><a href="#" class="hover:text-white">Community</a></li>
                        <li><a href="#" class="hover:text-white">Legal & Privacy</a></li>
                    </ul>
                </div>

                <!-- Social Media -->
                <div>
                    <h2 class="text-white font-bold text-xl mb-4 mt-20">Follow Us</h2>
                    <div class="flex space-x-4">
                        ...
                        <a href="#" class="hover:text-white"><i class="fab fa-linkedin-in"></i> LinkedIn</a>
                        <a href="#" class="hover:text-white"><i class="fab fa-instagram"></i> Instagram</a>
                    </div>
                </div>
            </div>
            <div class="container mx-auto text-center mt-10 border-t border-gray-700 pt-6">
                <p>&copy; 2024 GBY Exchange. All rights reserved.</p>
            </div>
        </footer>
